...
2. it is not a _summary_, you should have a point of view and express your own synthesis, understanding, and opinion about the topic under discussion
3. sometimes will relate to courses your taking now, your work, or your personal life
4. somteimes will relate to other things you have read or studied (this is ok, just give us a little bit of refernce and a way to find out more information)
...
* 2 points, editing: you need to edit it enough that it is smooth (no dead time, no gaps, no repeated questions, etc) and fits into the time. anything else is bonus.
...
Your podcast must be between 8-10 minutes in length. You can, but are not required to record it on a mobile device. I usually use a laptop computer, USB headset, and [Audacity](http://audacity.sourceforge.net/) for my audio recordings. The target audience for this podcast is members of our class. You should assume a base understanding of both mobile technology and mobile learning. Do not assume, though, more than a general understanding of your topic (if it is specialized). It is strongly advised that you write a script and practice before creating you final recording.
...
* clarity (2 points): make sure that recording is loud enough to hear easily, that you should speak clear, practice enough that you avoid "um" and "like", either edit out slacktime (dead air) or re-record your podcast so that it is tight

_You will lose 2 points for not uploading your podcasts on time._ You will receive zero points for this assignment if it's more than 1 day late.

### Educational App Review
"Apps", downloadable applications that run locally on a phone or tablet, you will write a review of a mobile app, from an educational perspective. Your review should be 500-800 words long. It should include the following elements:

0. introduction
1. description
    - how it works, 
    - the intended audiece
    - who publishes it
...
3. discuss the educational value
    - how could/is it used for learning?
    - what would someone learn from using this app?
    - what implicit/explicit theories of learning does it embody?
        - refer to the readings: communities of practice, situated cognition, constructionism, cognitive apprenticeship, etc.
...
Castells, M., Fernandez-Ardevol, M., LinchuanQiu, J., & Sey, A. (2006). *Mobile Communication and Society: A Global Perspective*. The MIT Press. 

Chaiprasurt, C., Esichaikul, V., & Wishart, J. (2011). [Designing Mobile Communication Tools: A Framework to Enhance Motivation in Online Learning Environment.](http://mlearn.bnu.edu.cn/source/ten_outstanding_papers/Designing%20Mobile%20Communication%20Tools%20A%20Framework%20to%20Enhance%20Motivation%20in%20Online%20Learning%20Environment.pdf) Presented at _mLearn 2011_, Beijing, China.
